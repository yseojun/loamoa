    ...
    <Container>
      {options.map((option, index) => (
        <EngravingOption key={index}>
          <StyledSelect
            value={option.engraving}
            onChange={(e) => handleChange(index, 'engraving', e.target.value)}
          >
          ...
          <StyledSelect
            value={option.abilityStone}
            onChange={(e) => handleChange(index, 'abilityStone', e.target.value)}
            disabled={!option.engraving}
          >
